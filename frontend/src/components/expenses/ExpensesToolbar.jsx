...
function ExpensesToolbar({ onCreate, onRefresh, searchTerm, onSearchChange, filtersOpen, onToggleFilters }) {
  return (
    <div className="mb-4 flex flex-col gap-4 rounded-xl bg-white p-4 shadow md:flex-row md:items-center md:justify-between">
      ...
      <ExpenseSearch value={searchTerm} onChange={onSearchChange} />
    </div>
  );
}
